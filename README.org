...
*** Yarn
    ...
    utilizado o [[https://yarnpkg.com/pt-BR/][Yarn]], pois possui algumas vantagens, como cache local de
    pacotes, melhor segurança, e determinismo na instalação de dependências.
